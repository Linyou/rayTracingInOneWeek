...
# Camera
class Camera:
    def __init__(self, vfov, aspect_ratio, image_width):
...
image_width = 1280
camera = Camera(90.0, aspect_ratio, image_width)
...
shpere_descriptor = []
shpere_descriptor.append({"shape_name": "shpere", "center": [-R,    0.0, -1.0], "raduis": R, "material": left_index})
shpere_descriptor.append({"shape_name": "shpere", "center": [ R,    0.0, -1.0], "raduis": R, "material": right_index})
