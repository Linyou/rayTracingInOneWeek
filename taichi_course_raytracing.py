...
# lookfrom[None] = ti.Vector([13.0,2.0,3.0])
# lookat[None] = ti.Vector([0.0,0.0,0.0])
...
def gen_objects():
    ...
    # material_ground = materials(0, ti.Vector([0.5, 0.5, 0.5]), 0.0)
    # material1 = materials(2, ti.Vector([1.0, 1.0, 1.0]), 1.5)
    # material2= materials(0, ti.Vector([0.4, 0.2, 0.1]), 0.0)
    # material3 = materials(1, ti.Vector([0.7, 0.6, 0.5]), 0.0)

    # world.add(sphere(ti.Vector([0.0, -1000.0, -1.0]), 1000, material_ground))
    ...
    #                 world.add(sphere(ti.Vector(center), 0.2, temp_material))
...
window = ti.ui.Window("Taichi RayTracer", (image_width, image_height), vsync=True)
